...
$(function () {
	...
	$("#btn_upload_team_data").on("click", function () {
		$.ajax({
			type: "POST",
			url: "/api/uppload_team?access_token=" + localStorage.getItem("token") ,
	...
	$.getJSON("/api/status?access_token=" + localStorage.getItem("token"), function (data) {
		...
		$.getJSON("/api/export_team_data?access_token=" + localStorage.getItem("token"), function (data) {
